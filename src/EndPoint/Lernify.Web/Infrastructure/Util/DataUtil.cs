...
namespace Lernify.Web.Infrastructure.Util
{
    public static class DataUtil
    {
        ...
        public static string ToPersianDate(this DateTimeOffset dateTime)
        {
            ...
            try
            {
                return string.Format("{0}/{1}/{2}", pc.GetYear(dateTime.UtcDateTime).ToString().PadLeft(4, '0'),
                    pc.GetMonth(dateTime.UtcDateTime).ToString().PadLeft(2, '0'),
                    pc.GetDayOfMonth(dateTime.UtcDateTime).ToString().PadLeft(2, '0'));
            }
            catch
            {
                return "";
        ...
        public static string ToPersianDateTime(this DateTimeOffset dateTime)
        {
            try
            {
                return string.Format("{0}:{1} {2}", dateTime.Hour.ToString().PadLeft(2, '0'),
        ...
        public static DateTimeOffset? ToGregorianDateTime(this string persianDate)
        {
